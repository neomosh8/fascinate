    ...
    def to_prompt(self) -> str:
        if self.exploration_mode:
            return (
                ...
                f"using {self.emotion} approach. Start with '{self.hook}' and see what resonates. "
            ...
            return (
                ...
                f"Apply {self.emotion} therapeutic techniques. Start with '{self.hook}' and go deeper "
                "into this area that showed strong emotional activation. This concept triggered significant "
                "neural response, so explore it therapeutically but safely. Be present and contained."
            )
